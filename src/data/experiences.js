export const experiences = {
  ...
  list: [
    ...
    },
    {
      title: 'CTO',
      company: 'FashionAI',
      description: 'As the Co-Founder and CTO of FashionAI, I lead all technology-related aspects of the company, driving innovation and efficiency across our platforms. My responsibilities include overseeing generative AI development, managing DevOps practices, building CI/CD pipelines, and ensuring robust infrastructure. I actively contribute to coding, utilizing a microservices architecture with services in Node.js and Python. <br><br> Our stack includes Kubernetes deployments on both GKE (Google Cloud Platform) and EKS (AWS), alongside databases such as PostgreSQL, MongoDB and Qdrant. I also design and implement Retrieval-Augmented Generation (RAG) pipelines, combining semantic search with generative models to deliver grounded and contextually accurate responses. This includes building data ingestion and embedding flows, storing vectors in Qdrant, and retrieving context at query time to enhance LLM outputs—powering use cases such as product search, CRM insights, and personalized recommendations. This role combines hands-on technical leadership with strategic vision to support our mission of delivering cutting-edge AI-driven solutions.',
